            ...
            tabPanel("Data processing",
                     ...
                     conditionalPanel (
                         ...
                         fluidRow(
                             ...
                             br(),
                             column(width = 10,
                                    my_withSpinner( plotOutput("VlnPlot", width = "auto", height = "auto") )
                             ),
                             column(width = 2,
                                    div(class = "option-group",
                                        radioButtons("Vln_box",
                                                     "Show as boxplot?",
                                                     choices = list("Yes" = 0,
                                                                    "No" = 1),
                                                     selected = c(0) )),
                                    div(class = "option-group",
                                        numericInput("min_count",
                                                     label = "Keep cells expressing at least this number of genes",
                                                     value = 1)),
                                    div(class = "option-group",
                                        numericInput("max_count",
                                                     label = "Exclude cells expressing more than this number of genes",
                                                     value = 10000)),
                         ...
                         conditionalPanel(
                             ...
                             fluidRow (
                                 ...
                                 column(width = 10,
                                        my_withSpinner( plotOutput("VlnPlot_filt", width = "auto", height = "auto") )
                                 ),
                                 # download plot
                                 column(2,
                     ...
                     conditionalPanel(
                         ...
                         fluidRow(
                             ...
                             conditionalPanel (
                                 ...
                                 br(),
                                 p("Be aware that this parameter is central in the definition of the number of clusters. It is recommended to try different values and choose the most appropriate according to the expectations of the number cell populations present in the sample. We find that a value within the range from 0.4 to 1.2 works well for most of the samples, but not for all." ),
                                 br(),
                                 column(width = 2,
                     ...
                     conditionalPanel(
                         ...
                         fluidRow(
                             ...
                             column(8,
                                    div(class = "down-group", id = "remove",
                                        my_withSpinner( plotOutput("cluster_size_plot",
                                                                   width = "auto", height = "auto") )
                                    ) ),
                             # download plot
                             column(2,
                                    numericInput_plot_height("p_new1_height"),
                                    numericInput_plot_width("p_new1_width", value=25),
                                    selectInput_plot_res("p_new1_res"),
                                    selectInput_plot_format("p_new1_format"),
                                    downloadButton("p_new1_down", HTML("Download Plot") )
                             ),
                         ), # Fluid row
